...
# "Priority-based I" (PR-I) policy, which also serves as the
# baseline scenario. The GCPModelPr1 class is built on the MESA framework and
...
class GCPModelPr1(mesa.Model):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.withdrawal_cutoff = kwargs.get("withdrawal_cutoff")
