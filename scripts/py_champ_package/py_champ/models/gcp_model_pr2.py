...
# "Priority-based I" (PR-II) policy, which also serves as the
# baseline scenario. The GCPModelPr2 class is built on the MESA framework and
...
class GCPModelPr2(mesa.Model):
    """
    A Mesa model for simulating the Priority-Based Pumping I (PR-I) scenarios.
    ...
    def __init__(
        ...
        **kwargs,
        ...
        """
        Initializes the GCPModelPr1 instance.
        """
        ...
        # --- 2c. Policy-Specific Parameters ---
        self.senior_farmers_number = kwargs.get("senior_farmers_number")
        self.accumulated_withdrawal = 0 # This will track pumping within a year
        self.seniority_id_count = 0 # This will track no of senior farmers receiving water within a year

        # --- 2d. Store Model Parameters and Input Data ---
        ...
        # --- 2e. Initialize Scheduler and Gurobi Environment ---
        ...
        # --- 2f. Apply Shared Configuration Overrides ---
        ...
        agent_reporters = {
            ...
            # Behavior Reporters
            "seniority": get_agt_attr("seniority_id"),
            "yield_rate": get_agt_attr("yield_rate"), "profit": get_agt_attr("profit"),
            "profit_per_field": get_agt_attr("avg_profit_per_field"),
            ...
            "total_field_area": get_agt_attr("total_field_area"), "zero_irrigation_reason": get_agt_attr("zero_irrigation_reason"),
            # Internal Check
    ...
    def step(self):
        ...
        self.current_year += 1
        self.t += 1
        #Reset the accumulated withdrawal and no of senior farmers at the start of each year
        self.accumulated_withdrawal = 0
        self.seniority_id_count = 0
