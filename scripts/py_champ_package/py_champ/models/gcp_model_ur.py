...
# "Uniform Pumping Restriction" (UR) policy, which also serves as the
# baseline scenario. The GCPModelUr class is built on the MESA framework and
...
class GCPModelUr(mesa.Model):
    """
    A Mesa model for simulating the baseline and uniform pumping restriction scenarios.
    ...
    def __init__(
        ...
        **kwargs,
        ...
        """
        Initializes the GCPModelUr instance.
        """
