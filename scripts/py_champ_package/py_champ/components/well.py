...
# well.py
#
# This script defines the Well class, which simulates a single groundwater well.
# Each Well agent manages its own physical and hydraulic properties, such as
# saturated thickness and transmissivity. It is responsible for calculating the
# energy required for pumping based on withdrawal amounts and aquifer conditions.
#
